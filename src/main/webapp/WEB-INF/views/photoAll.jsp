...
<div class="col-lg-3">
			...
			<div class="list-group">
				...
				<a href="#" class="list-group-item active">갤러리</a> 
			</div>
		</div>
		<!-- /.col-lg-3 -->
		<div class="col-lg-9">
			...
			<div class="row text-center text-lg-left">
				...
				<div class="col-lg-3 col-md-4 col-6">
					<a href="../board/get?boardNo=${item.boardNo }" class="d-block mb-4 h-100">
					<img class="img-fluid img-thumbnail" src="${ item.fileName}" alt="">
					</a>
				</div>
				</c:forEach>
			</div>
...
<!--                      페이지 색칠 -->
			...
			<form id='searchForm' action="/photoAll" method="get">
...
<form id='actionForm' action="/photoAll" method="get">
	<input type="hidden" name='pageNum' value='${pageMaker.cri.pageNum }'>
	<input type="hidden" name='amount' value='${pageMaker.cri.amount }'>
